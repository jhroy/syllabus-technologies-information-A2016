...
###1
D'abord, envoyez-moi par courriel avant 23h59 le 31 octobre 2016 un script python qui fait du moissonnage de données directement sur un site web ou par le biais d'un API. Les détails sont décrits dans la section [Travaux](/travaux.md). 
